  ...
  return (
    <div className={styles.container}>
      <Helmet>
        ...
        {/* SEO 핵심 */}
        <title>청주 센트럴 더 플래티넘– 호수배치도</title>
        <meta
          name="description"
          content="청주 센트럴 더 플래티넘호수배치도를 통해 세대별 위치와 배치 구조를 확인하세요."
        />
        <meta
          name="keywords"
          content="청주 센트럴 더 플래티넘, 호수배치도, 세대배치, 동호수 안내, 청주 아파트"
        />
        ...
        <meta property="og:title" content="청주 센트럴 더 플래티넘– 호수배치도" />
        <meta
          property="og:description"
          content="청주 센트럴 더 플래티넘호수배치도에서 세대 위치와 배치 구조를 한눈에 확인하세요."
        />
        ...
        <meta property="og:image:alt" content="청주 센트럴 더 플래티넘호수배치도" />

        {/* Twitter */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="청주 센트럴 더 플래티넘– 호수배치도" />
        <meta
          name="twitter:description"
          content="청주 센트럴 더 플래티넘호수배치도를 통해 세대 위치를 확인하세요."
        />
