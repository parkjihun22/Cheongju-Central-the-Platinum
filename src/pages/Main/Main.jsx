        ...
        <>
          ...
          <div className={styles.imageContainer}>
            ...
            <div className={styles.mainImageTextSub}>
              ...
              도심을 대표하는 랜드마크
              <span className={styles.greyText}> 새로운 주거 가치</span> |
              품격 있는 라이프스타일
              <span className={styles.greyText}> 청주 센트럴 더 플래티넘</span>
            </div>
          ...
          <div className={styles.section}>
            <div className={styles.section1}>
              ...
              <div className={styles.menuBox}>
                <img
                  src={section1_Image1}
                  alt="청주 센트럴 더 플래티넘 브랜드소개 두번째 이미지"
                />
              ...
              <div className={styles.textBox}>
                ...
                <div className={styles.subTitle}>
                  ...
                  <div className={styles.subText}>
                    ...
                    <br />
                    청주 센트럴 더 플래티넘이 함께합니다
                  </div>
                </div>
              </div>
              <img
                src={section8Img3}
                alt="청주 센트럴 더 플래티넘 입지환경 소개 이미지"
              />
            </div>
          </div>
          ...
          <div className={styles.section}>
            <div className={styles.section4}>
              <div className={styles.imageBox}>
                <img
                  src={section4_Image1}
                  alt="청주 센트럴 더 플래티넘 브랜드소개-image4"
                />
                <div className={styles.text1}>청주 센트럴 더 플래티넘</div>
          ...
          <div className={styles.pcVisitContainer}>
            ...
            <form
              ...
              action="https://formspree.io/f/mgolbjyz"
              method="POST"
            >
              <label htmlFor="name">
              ...
              <div className={styles.textBox}>
                ...
                <div className={styles.subTitle}>
                  ...
                  <div className={styles.subText}>
                    찬란한 비전에 완벽한 주거가치까지 더해
                    <br />
                    청주 센트럴 더 플래티넘가 함께합니다
                  </div>
                </div>
              </div>
              <img src={map1} alt="청주 센트럴 더 플래티넘 오시는길안내-image1" />
            </div>
          </div> */}
        ...
        <div className={styles.mobileMain}>
          ...
          <div className={styles.imageContainer}>
            ...
            <div className={styles.mainImageTextSub1}>
              ...
              새로운 주거 기준을 제시하는
              <br />
              <span className={styles.greyText1}>청주 센트럴 더 플래티넘</span>
            </div>
         ...
         <div className={styles.mobileMiddleImage}>
          ...
          <div className={styles.container7}>
            ...
            <img
              src={section8Img3}
              alt="청주 센트럴 더 플래티넘 모바일 입지안내 이미지"
            />
          </div>
          ...
          <div className={styles.container3}>
            <div className={styles.textbox}>
              ...
              <div className={`${styles.text4} fadeUpRepeat`}>
                살수록 자부심이 차원이 다른
                <br />
                프리미엄 주거라이프를 <br /> 청주 센트럴 더 플래티넘에서<br />
                확인하세요
              </div>
            </div>
            <img
              src={section2_Image1}
              alt="청주 센트럴 더 플래티넘 모바일 조감도 이미지"
            />
          </div>
          ...
          {/* <div className={styles.container2}>
            <div>
              <img
                src={section1_Image1}
                alt="청주 센트럴 더 플래티넘 브랜드소개 mobile-image5"
              />
          ...
          {/* <div className={styles.section}>
            <div className={styles.section9}>
              <img
                src={mobilemap1}
                alt="청주 센트럴 더 플래티넘 오시는길안내-mobileimage2"
              />
            </div>
          </div> */}
